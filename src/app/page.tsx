                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    transform: canAct && playable ? 'translateY(-10px)' : 'translateY(0px)', // FIXED: increased lift from -18px to -28px
                                    transition: 'transform 0.18s ease',
                                    marginBottom: canAct && playable ? '10px' : '0px', // FIXED: added margin to prevent clipping
                                }}
                            >
                                <Image
                                    src={card.src}
